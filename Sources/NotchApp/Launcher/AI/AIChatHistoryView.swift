        ...
        VStack(spacing: 10) {
            ...
            if conversations.isEmpty {
                ...
                ForEach(conversations) { conversation in
                    HStack(spacing: 8) {
                        ...
                        Button {
                            ...
                            Image(systemName: conversation.isPinned ? "pin.fill" : "pin")
                                .foregroundStyle(conversation.isPinned ? Color.signalMint : .white.opacity(0.4))
                    ...
                    .background(.white.opacity(store.activeConversationID == conversation.id ? 0.07 : 0.025),
